...
import se.flightplanner.Airspace.VariantInfo;
...
public class ViewAdInfo extends Activity {
	...
	private void show_aip(AipText aiptext) {
		...
		intent.putExtra("se.flightplanner.htmlpath", aiptext.get_datapath().getAbsolutePath()); 
		startActivity(intent);
	}
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	icao=getIntent().getStringExtra("se.flightplanner.icao");
